...
private:
   ...
   */
   ...
   vector<int> sumFourVectors(vector<int> one, vector<int> two, vector<int> three, vector<int> four);

   vector<int> sumTwoVectors(vector<int> one, vector<int> two);

   PNG * SEcreateIMG(PNG * im, pair<int,int> point, int k);
   PNG * SWcreateIMG(PNG * im, pair<int,int> point, int k);
   PNG * NWcreateIMG(PNG * im, pair<int,int> point, int k);
   PNG * NEcreateIMG(PNG * im, pair<int,int> point, int k);

   HSLAPixel FindPixel(pair<int,int> find, Node * curr);
};
